              ...
              <form>
                ...
                <div className='form-group'>
                  ...
                  <div className='input-cont'>
                    ...
                    <input className={`${styles.passwordbutton} ${styles.noLeftPadding}`} type='password' id='password' name='password' value={password} onChange={handlePasswordChange} placeholder='Enter your password' />
                  </div>
                </div>
